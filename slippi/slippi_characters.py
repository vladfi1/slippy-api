...
SlippiCharacterId: dict[str, int] = {
...
SlippiCharacterColors: dict[str, str] = {
  'DONKEY_KONG': '#2f1003',
...
def get_key_from_value(value: int, mapping: dict[str, int]) -> str | None:
...
def get_character_name(char_id: int) -> str | None:
...
def get_character_id(name: str, dk_claus: bool = False) -> int | None:
